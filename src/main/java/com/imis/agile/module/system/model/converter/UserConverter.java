...
import com.imis.agile.module.system.model.dto.UserExcelDTO;
...
public interface UserConverter {
    ...
    @Mappings({
            ...
            @Mapping(target = "birthday", expression = "java(com.imis.agile.util.IdCardUtil.getBirthByIdCard(add.getIdentityNumber()))"),
            @Mapping(target = "sex", expression = "java(com.imis.agile.util.IdCardUtil.getSex(add.getIdentityNumber()))"),
    ...
    @Mappings({
            ...
            @Mapping(target = DataBaseConstant.UPDATE_TIME, ignore = true),
            @Mapping(target = "salt", expression = "java(com.imis.agile.util.PasswordUtil.getStringSalt())"),
            @Mapping(target = "password", expression = "java(com.imis.agile.util.PasswordUtil.encrypt(user.getUsername(), user.getUsername(), user.getSalt()))"),
            @Mapping(target = "status", constant = "0"),
            @Mapping(target = "delFlag", constant = "0"),
    })
    ...
    @Mappings({
            ...
            @Mapping(target = "birthday", expression = "java(com.imis.agile.util.IdCardUtil.getBirthByIdCard(update.getIdentityNumber()))"),
            @Mapping(target = "sex", expression = "java(com.imis.agile.util.IdCardUtil.getSex(update.getIdentityNumber()))"),
