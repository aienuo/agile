...
@ApiModel(value = "在线开发 - 表单元素 - 返回值", description = "在线开发 - 表单元素 - 返回值")
public class FormElementVO implements Serializable {
     ...
     * 禁用状态
     */
    @ApiModelProperty(value = "禁用状态(true 为禁用)")
    ...
    /**
     * 多选时用户最多可以选择的项目数，（0 则不限制）
     */
    @ApiModelProperty(value = "多选时用户最多可以选择的项目数，（0 则不限制）")
