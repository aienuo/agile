 ...
 */
@Data
@Schema(title = "菜单权限详细信息 - 查询返回值", description = "菜单权限详细信息 - 查询返回值")
...
public class MenuInfoVO implements Serializable {
     ...
     * 菜单权限编号
     */
    @Schema(title = "菜单权限编号", description = "菜单权限编号")
    private String id;
     ...
     * 按钮权限冻结状态(0-正常，1-冻结）
     */
    @Schema(title = "按钮权限冻结状态(0-正常，1-冻结）", description = "按钮权限冻结状态(0-正常，1-冻结）")
