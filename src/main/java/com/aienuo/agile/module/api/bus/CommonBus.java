...
import com.aienuo.agile.module.api.model.vo.FileVO;
import com.aienuo.agile.module.system.model.converter.FileConverter;
...
public class CommonBus extends BaseBus {
     ...
     * 文件存储类型（本地：local）
     */
    @Value(value = "${aienuo-boot.uploadType}")
    ...
    public BaseResponse doFileDownload(final Long fileId) {
        ...
        // 2.获取文件信息
        File sysFile = this.fileService.getById(fileId);
